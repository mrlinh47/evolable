...
class acf_qtranslate_qtranslatex {
	...
	public function admin_head() {
		...
		if ($translate_standard_field_types) {
			?>
			<script>
			var acf_qtranslate_translate_standard_field_types = <?php echo json_encode($translate_standard_field_types); ?>;
			console.log(acf_qtranslate_translate_standard_field_types);
			</script>
			<?php
		}
	}
