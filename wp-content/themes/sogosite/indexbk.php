				...
				<div class="item">
					<div class="column-blk">
						<?php if ( has_post_thumbnail()) :
						 ...
						 <?php if (qtrans_getLanguage()=='en'){ ?>
						<a href="<?php echo str_replace("/en/company/","/company/en/columns/",get_permalink()); ?>" class="news-title"><?php echo mb_strimwidth(get_the_title(), 0, 30, '...'); ?></a>

			        <?php }else if (qtrans_getLanguage()=='vi'){ ?>
			            <a href="<?php echo str_replace("/vi/company/","/company/vi/columns/",get_permalink()); ?>" class="news-title"><?php echo mb_strimwidth(get_the_title(), 0, 30, '...'); ?></a>
			        <?php }else if (qtrans_getLanguage()=='ja'){ ?>
			            <a href="<?php echo str_replace("/ja/company/","/company/ja/columns/",get_permalink()); ?>" class="news-title"><?php echo mb_strimwidth(get_the_title(), 0, 30, '...'); ?></a>
			        <?php } ?>
