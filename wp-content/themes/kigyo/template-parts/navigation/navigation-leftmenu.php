...
?>
        <ul class="nav navbar-nav" id="top-nav">
         <li class="">
              ...
              <li>
                 <a href="<?php echo get_site_url(); ?>/<?php echo qtranxf_getLanguage(); ?>/column-index">
                 <?php if (qtrans_getLanguage()=='ja'){ ?>
                    コラム / ブログ
                    <?php }else if (qtrans_getLanguage()=='vi'){ ?>
               ...
               <li  class="nav-parrent">
                ...
                ?>
                   ...
                   <ul class="sub-nav">
                    <li><a href="<?php echo get_site_url(); ?>/<?php echo qtranxf_getLanguage(); ?>/interviews">
                    <?php if (qtrans_getLanguage()=='ja'){ ?>
                    利用者インタビュー
                  <?php }else if (qtrans_getLanguage()=='vi'){ ?>
                  ...
                  <?php } ?>
                    ...
                    <li>
                      <?php
                  switch_to_blog(2); ?> 
                  <a href="<?php echo get_site_url().'/'.qtranxf_getLanguage().'/job-apply/'; ?>">
                  <?php if (qtrans_getLanguage()=='ja'){ ?>
                    応募フォーム
                  <?php }else if (qtrans_getLanguage()=='vi'){ ?>
                    Nộp đơn xin việc
               ...
               <li>
                   <a href="<?php echo get_site_url(); ?>/<?php echo qtranxf_getLanguage(); ?>/about">
                   <?php if (qtrans_getLanguage()=='ja'){ ?>
                    企業概要
                  <?php }else if (qtrans_getLanguage()=='vi'){ ?>
