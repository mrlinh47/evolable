<?php
	if(!function_exists('load_news_page_single')){
		function load_news_page_single(){
			...
			if ( $query->have_posts() ) {
				while ( $query->have_posts() ) : $query->the_post();
					...
					$htmlRender .= '<div class="col-md-4 col-sm-4 news-list__item">';
		...
		add_shortcode('load_news_page_single', 'load_news_page_single');
	}
?>